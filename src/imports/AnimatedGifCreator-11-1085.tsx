import svgPaths from "./svg-xs0sgp4s23";
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="x-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="x-circle">
          <path d={svgPaths.p28688500} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
...
function Top() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Top">
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[32px] not-italic relative shrink-0 text-[32px] text-center text-nowrap text-white whitespace-pre">Upgrade</p>
      <XCircle />
    </div>
  );
}
...
function Component() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0 w-full" data-name="10">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between leading-[32px] not-italic px-[24px] py-[16px] relative text-[24px] text-center text-nowrap text-white w-full whitespace-pre">
          <p className="font-['Inter:Regular',_sans-serif] font-normal relative shrink-0">10 generations</p>
          <p className="font-['Inter:Medium',_sans-serif] font-medium relative shrink-0">5$</p>
        </div>
      </div>
    </div>
  );
...
function Component1() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0 w-full" data-name="20">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between leading-[32px] not-italic px-[24px] py-[16px] relative text-[24px] text-center text-nowrap text-white w-full whitespace-pre">
          <p className="font-['Inter:Regular',_sans-serif] font-normal relative shrink-0">20 generations</p>
          <p className="font-['Inter:Medium',_sans-serif] font-medium relative shrink-0">8$</p>
        </div>
      </div>
    </div>
  );
...
function Component2() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0 w-full" data-name="30">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between leading-[32px] not-italic px-[24px] py-[16px] relative text-[24px] text-center text-nowrap text-white w-full whitespace-pre">
          <p className="font-['Inter:Regular',_sans-serif] font-normal relative shrink-0">30 generations</p>
          <p className="font-['Inter:Medium',_sans-serif] font-medium relative shrink-0">11$</p>
        </div>
      </div>
    </div>
  );
...
function Upgrade() {
  return (
    <div className="absolute backdrop-blur-[50px] backdrop-filter bg-[rgba(47,47,47,0.6)] box-border content-stretch flex flex-col gap-[41px] items-start left-[756px] pb-[48px] pt-[32px] px-[32px] rounded-[12px] top-[176.02px] w-[471px]" data-name="Upgrade">
      <Top />
      <Options />
    </div>
  );
...
function Paragraph28() {
  return (
    <div className="absolute content-stretch flex items-start left-[1575px] opacity-40 top-[calc(50%-0.5px)] translate-y-[-50%]" data-name="Paragraph">
...
function Container49() {
  return (
    <div className="absolute backdrop-blur-[6px] backdrop-filter bg-[rgba(255,255,255,0.15)] h-[80px] left-0 top-0 w-[1916px]" data-name="Container">
      <Container48 />
      <Paragraph25 />
      <ChevronRight />
      <Paragraph26 />
